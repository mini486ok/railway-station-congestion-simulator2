export function UsageGuide() {
  return (
    <div className="guide">
      ...
      <h3>5. 방향성과 그룹</h3>
      <p>
        승객이 되돌아오지 않게 하려면 <strong>역방향 링크를 만들지 마세요.</strong>
      </p>
      <p>
        같은 물리적 장소를 <em>입구 방향</em>과 <em>출구 방향</em> 두 노드로 나눌 때는,
        두 노드에 <strong>같은 "그룹" 이름</strong>을 부여하세요.
        그러면 혼잡도 계산 시 두 노드의 인원이 합산되어 현실적인 값을 얻을 수 있습니다.
      </p>
      <ul>
