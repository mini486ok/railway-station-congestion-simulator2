...
2,10.0,11.2,3.1,0.0,0.0`}</pre>
      ...
      <p>
        <strong>2노드/그룹 모델링</strong>에서는 같은 물리 공간을 두 노드(예: 승강장 승차/하차)로 나누고
        같은 그룹 이름을 부여합니다. 이 파일에서는 그 두 노드의 인원이 합산되어 실제 장소 단위 혼잡도로
        출력됩니다. GNN 학습 시 물리 공간 기준 레이블로 바로 활용할 수 있습니다.
      </p>
      <ul>
