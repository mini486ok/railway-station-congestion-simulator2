    ...
    ρ: 현재 밀도(인/m²), v_free: 자유속도, ρ_max: 임계밀도, γ: 형상 계수`}
      ...
      <ol>
        ...
        <li>
          ...
          노드가 많으므로 미니맵과 그래프 뷰 좌측 하단 화면 맞춤 버튼이 유용합니다. <strong>병목·수직이동</strong> 분석에 적합합니다.
        </li>
        <li>
      ...
      <details>
        ...
        <p>
          노드를 직접 드래그해 위치를 옮기세요.
          템플릿이나 설정 파일을 불러오면 노드가 계층형 레이아웃으로 자동 배치됩니다.
          그래프 뷰 좌측 하단의 <strong>± 확대/축소</strong> 버튼이나 <strong>화면 맞춤(핏)</strong> 버튼을 활용하면
          전체 구조를 한눈에 볼 수 있으며, 노드가 많을 때는 미니맵을 사용하세요.
        </p>
      </details>
