  ...
  return (
    <div className="guide">
      ...
      <ol>
        ...
        <li>
          <strong>대시보드 확인</strong> — 가운데 패널 아래쪽 대시보드에서 시계열 혼잡도 차트·총 재실·누적 발생·누적 이탈을 확인합니다.
        </li>
        <li>
...
{`v(ρ) = v_free × [ 1 − exp(−γ × (1/ρ − 1/ρ_max)) ]
    ρ: 현재 밀도(인/m²), v_free: 자유속도, ρ_max: 임계밀도, γ: 형상 계수`}
      ...
      <p>아래 12개 내장 템플릿은 모두 2노드/그룹 규칙을 적용한 검증된 역사 구성입니다.</p>
      <ol>
        <li>
        ...
        <li>
          <strong>초대형 복합 환승역</strong> — 40노드 이상.
          3개 노선·복층 대합실·다중 출입구를 갖춘 초대형 역사 시나리오.
          대규모 GNN 학습 데이터 생성 및 복잡한 환승 흐름 분석에 활용하세요.
        </li>
      </ol>
